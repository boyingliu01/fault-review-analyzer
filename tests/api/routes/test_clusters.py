...
class TestGetClusters:
    ...
    def test_populated_cache_with_noise(self, client):
        ...
        import src.api.routes.clusters as cluster_routes
        cluster_routes._cluster_cache = {
            0: {"size": 5, "label": "OOM issues", "keywords": ["memory", "heap"], "metadata": {"confidence": 0.9}},
            1: {"size": 3, "label": "Timeout issues", "keywords": ["timeout", "connection"], "metadata": {}},
    ...
    def test_cluster_info_fields(self, client):
        ...
        import src.api.routes.clusters as cluster_routes
        cluster_routes._cluster_cache = {
            5: {"size": 10, "label": "Network Errors", "keywords": ["dns", "tcp", "retry"], "metadata": {"pattern": "intermittent"}},
        }
    ...
    def test_found_with_tasks(self, client):
        ...
        cluster_routes._cluster_cache = {
            42: {
                ...
                "tasks": [
                    {"task_id": "1001", "title": "XSS in form", "description": "no escaping", "similarity_score": 0.95},
                    {"task_id": "1002", "title": "SQL injection", "description": "unsanitized input", "similarity_score": 0.88},
                ],
            },
        }
