...
- 复杂度与特性
  ...
  - 幂等写入（同 task_id 覆盖）
  - 线程安全：基于 sqlite3 连接上下文，适合进程内串行访问
...
- [src/cache/manager.py:37-76](file://src/cache/manager.py#L37-L76)
- [src/cache/manager.py:78-88](file://src/cache/manager.py#L78-L88)
...
- [src/cache/manager.py:140-165](file://src/cache/manager.py#L140-L165)
- [src/cache/models.py:8-22](file://src/cache/models.py#L8-L22)
...
- [src/embedding/generator.py:37-44](file://src/embedding/generator.py#L37-L44)
...
章节来源
- [src/config/models.py:84-96](file://src/config/models.py#L84-L96)
- [src/embedding/generator.py:16-18](file://src/embedding/generator.py#L16-18)
- [src/storage/chroma_manager.py:285-349](file://src/storage/chroma_manager.py#L285-L349)
...
- [src/embedding/generator.py:25-52](file://src/embedding/generator.py#L25-L52)
...
章节来源
- [tests/test_cache.py:34-91](file://tests/test_cache.py#L34-L91)
...
- [tests/cache/test_manager_task22.py:186-196](file://tests/cache/test_manager_task22.py#L186-L196)
- [tests/cache/test_manager_task22.py:219-237](file://tests/cache/test_manager_task22.py#L219-L237)

## 结论
本缓存管理系统通过“内存 LRU + SQLite 任务缓存 + 向量库持久化 + 本地降级”的多级架构，在保证高性能的同时兼顾了可用性与最终一致性。配合完善的 TTL、容量控制、失效与清理机制，以及丰富的统计与 CLI 工具，能够满足复杂分析场景下的缓存需求。建议在生产环境结合业务特征调优 TTL 与容量，并建立定时清理与同步任务，以获得更稳定的运行表现。